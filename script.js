...
function buyDef100m() {
  if (stats.mana >= 100000000) {
    stats.mana -= 100000000;
    stats.def += 1000000;
    updateStats();
...
function buyDef1b() {
  if (stats.mana >= 1000000000) {
    stats.mana -= 1000000000;
    stats.def += 10000000;
    updateStats();
...
function buyDef10b() {
  if (stats.mana >= 10000000000) {
    stats.mana -= 10000000000;
    stats.def += 100000000;
    updateStats();
...
function buyDef100b() {
  if (stats.mana >= 100000000000) {
    stats.mana -= 100000000000;
    stats.def += 1000000000;
    updateStats();
...
function buyDef1t() {
  if (stats.mana >= 1000000000000) {
    stats.mana -= 1000000000000;
    stats.def += 10000000000;
    updateStats();
...
function buyDef10t() {
  if (stats.mana >= 10000000000000) {
    stats.mana -= 10000000000000;
    stats.def += 100000000000;
    updateStats();
...
function buyDef100t() {
  if (stats.mana >= 100000000000000) {
    stats.mana -= 100000000000000;
    stats.def += 1000000000000;
    updateStats();
